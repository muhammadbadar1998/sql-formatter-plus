...
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); } // Old ES Module syntax:
...
var tokenizer;
var StandardSqlFormatter = exports["default"] = /*#__PURE__*/function () {
  /**
   ...
   */
  return _createClass(StandardSqlFormatter, [{
    key: "format",
    value: function format(query) {
      ...
      var formattedQuery = new _Formatter["default"](this.cfg, tokenizer).format(query);

      // Add newlines before any JOIN keywords
      var joinKeywords = ['JOIN', 'INNER JOIN', 'LEFT JOIN', 'RIGHT JOIN', 'OUTER JOIN', 'ON'];

      // Replace occurrences of JOIN with two newlines before
      var finalFormattedQuery = formattedQuery.replace(new RegExp("(".concat(joinKeywords.join('|'), ")"), 'gi'),
      // Case insensitive match for JOIN keywords
