...
const {
  format
} = require('../lib/sqlFormatter'); // This function is called when your extension is activated
...
function activate(context) {
  ...
  let disposable = vscode.commands.registerCommand('extension.formatSQL', function () {
    ...
    const fullText = document.getText(); // Call your formatting function (sqlFormatter) here

    const formattedSQL = format(fullText, {
      language: 'sql',
      indent: '  ',
      uppercase: true
